...
$tabBar.on("click", "li", function (e) {
  var $li = (0, _jquery.default)(e.currentTarget); // 可以得到li

  $li.addClass("selected").siblings().removeClass("selected");
  var index = $li.index();
  $tabContent.children().eq(index).addClass("active") // 这样我不用直接操作css,我可以在css中定义.active的样式
...
$square.on('click', function () {
  $square.toggleClass('active'); // addClass/removeClass的切换
});
